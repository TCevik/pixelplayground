...
const wordList = [
    'WATER', 'NACHT', 'LICHT', 'SUPER', 'TAFEL', 'STOEL', 'APPEL', 'BROOD',
    'VADER', 'LEVEN', 'VROUW', 'ZWART', 'GROEN', 'BLAUW', 'BRUIN', 'KLEUR',
    'PAARD', 'VOGEL', 'KATER', 'STORM', 'REGEN', 'KOUDE', 'DROOG', 'NATTE',
    'SLANG', 'BEVER', 'GROOT', 'KLEIN', 'STERK', 'ZWAAR', 'GROND', 'AARDE',
    'SPOOR', 'TREIN', 'AUTOS', 'FIETS', 'STEEG', 'PLEIN', 'MARKT', 'KASSA',
    'PRIJS', 'KOPEN', 'DRANK', 'VLEES', 'KAZEN', 'FRUIT', 'TAART', 'GEBAK',
    'SNOEP', 'ZOUTE', 'PEPER', 'KROON', 'PRINS', 'PAARS', 'KOPER', 'STAAL',
    'IJZER', 'STEEN', 'PLANK', 'MUREN', 'DAKEN', 'RAMEN', 'VLOER', 'SLAAP',
    'DROOM', 'AVOND', 'VROEG', 'MAAND', 'JAREN', 'WEKEN', 'DAGEN', 'HEDEN',
    'LOPEN', 'STAAN', 'LEZEN', 'STIFT', 'TEKEN', 'KUNST', 'BEELD', 'FILMS',
    'VIDEO', 'FOTOS', 'KADER', 'ZINGT', 'DANST', 'FEEST', 'KLEED', 'BROEK',
    'SHIRT', 'SJAAL', 'BENEN', 'ARMEN', 'HOOFD', 'HAREN', 'KIJKT', 'HOORT',
    'RUIKT', 'VOELT', 'PROEF', 'LACHT', 'HUILT', 'ANGST', 'VREDE', 'RUZIE',
    'VECHT', 'WINST', 'SPORT', 'MEREN', 'SCHIP', 'BOTEN', 'HEMEL', 'BRAND',
    'MACHT', 'RECHT', 'BOETE', 'NEPPE', 'ZACHT', 'HARDE', 'KORTE', 'LANGE',
    'DIEPE', 'RONDE', 'KRUIS', 'REEKS', 'GROEP', 'HELFT', 'ALLES', 'NIETS',
    'GETAL', 'ZEVEN', 'NEGEN', 'EERST', 'BLIND', 'NIEUW', 'JONGE', 'GRIJS',
    'REIST', 'KAART', 'TRAAG', 'DIKKE', 'DUNNE', 'VOLLE', 'DICHT', 'LOSSE',
    'HAGEL', 'VRIES', 'LENTE', 'ZOMER', 'STAAT', 'KRIJG', 'GEEFT', 'NEEMT',
    'HOUDT', 'MAAKT', 'BOUWT', 'BREEK', 'WERKT', 'SPEEL', 'BEKEN'
]; 
let targetWord = "";
let currentRow = 0;
let currentTile = 0;
